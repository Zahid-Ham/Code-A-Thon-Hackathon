                    ...
                    <AnimatePresence mode="wait">
                        {activeTab === 'DASHBOARD' && (
                            ...
                            >
                                ...
                                >
                                    <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1518364538800c17?q=80&w=2070&auto=format&fit=crop')] bg-cover opacity-20 filter grayscale-50 group-hover:scale-110 transition-transform duration-700" />
