...
const PlaceholderPage = ({ title, color }) => (
  <div className="w-full h-screen flex flex-col items-center justify-center bg-black text-white relative overflow-hidden">
     ...
     <a href="/" className="mt-8 px-6 py-2 border border-white/20 rounded-full hover:bg-white/10 transition-colors z-10">
       Return to Bridge
     </a>
  </div>
);

export const EventDashboardPlaceholder = () => <PlaceholderPage title="Celestial Command" color="#00F0FF" />;
export const SolarOverwatchPlaceholder = () => <PlaceholderPage title="Solar Overwatch" color="#FFD700" />;
export const ChronoArchivePlaceholder = () => <PlaceholderPage title="Chrono-Archive" color="#FF0055" />;
export const AcademyPlaceholder = () => <PlaceholderPage title="Academy" color="#00FF99" />;
